...
public class FanetykaTestArfaep {
    ...
    public static void main(String[] args) throws Exception {
        List<String> lines = FileUtils.readLines(new File("src-voice/org/alex73/korpus/voice/arfaep.txt"));
        List<String> skip = FileUtils.readLines(new File("src-voice/org/alex73/korpus/voice/arfaepSkip.txt"));
