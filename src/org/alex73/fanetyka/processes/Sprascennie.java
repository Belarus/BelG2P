...
public class Sprascennie {
    ...
    @ProcessCase(name = "Спрашчэнне: с'-ц' + зычны",logCountBefore = 3, logCountAfter = 2)
    ...
    @ProcessCase(name = "Спрашчэнне: з'-д' +(звонкі ці санорны ў наступным слове) -> з'",logCountBefore = 3, logCountAfter = 2)
...
//    }
    ...
    @ProcessCase(name = "Спрашчэнне: т-с -> ц",logCountBefore = 2, logCountAfter = 1)
    public boolean ts(Huk huk, ProcessContext context) {
    ...
    public boolean ts_miaza(Huk huk, ProcessContext context) {
        huk.bazavyHuk = BAZAVY_HUK.ц;
        return true;
    }
